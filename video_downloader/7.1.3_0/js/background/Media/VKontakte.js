...
console.log(media);		
		...
		function storeMedia( media, data ){
			...
			{	
				...
				if ( _b(fvdSingleDownloader.Prefs.get( "fvd.display_vk_button" ) ) && data.tabId ) {
...
/* 					if ( /vk.com\/video\?z=([^.]*)/i.test(data.url.toLowerCase()) )	{
					
								checkVKontakteVideo( data, function( mediaToSave )  {
