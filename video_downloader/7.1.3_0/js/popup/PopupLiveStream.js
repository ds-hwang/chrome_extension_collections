(function(){
	...
	var PopupLiveStream = function(){
		...
		this.click = function( item, media ){		
			...
			console.log('fvdSingleDownloader.Popup.PopuLiveStream', item, media);
			...
			if ( st == 'stop') {
				fvdSingleDownloader.Media.startCombine( media, function(size) { 
				...
				fvdSingleDownloader.Media.stopCombine( media );
	...
	this.PopupLiveStream = new PopupLiveStream();
